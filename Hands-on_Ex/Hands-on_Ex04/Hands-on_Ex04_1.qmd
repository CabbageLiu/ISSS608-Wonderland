...
Here we will be introducing two new statistical graphic methods to visualize distribution, which are `ridgeline plot` and `raincloud plot` by using ggplot2 and its extensions
