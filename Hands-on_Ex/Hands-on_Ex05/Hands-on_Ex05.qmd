...
2.  `as_tbl_graph()` converts network data and objects to a **tbl_graph** network. Below are network data and object supported by **as_tbl_graph()**
...
![](images/clipboard-3228805375.png)
...
## Plotting the 1st interactive network graph
